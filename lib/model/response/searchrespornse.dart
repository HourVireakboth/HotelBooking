...
SearchResponseModel roomModelFromJson(String str) => SearchResponseModel.fromJson(json.decode(str));

String roomModelToJson(SearchResponseModel data) => json.encode(data.toJson());
...
class SearchResponseModel {
    ...
    factory SearchResponseModel.fromJson(Map<String, dynamic> json){ 
        return SearchResponseModel(
            data: json["data"] == null ? [] : List<SearchResponseData>.from(json["data"]!.map((x) => SearchResponseData.fromJson(x))),
        );
    }
